...
1. [Create an issue](https://github.com/bem/bem-react-components/issues/new) with a proper description.
...
The list of contributors is available at https://github.com/bem/bem-react-components/graphs/contributors. You may also get it with `git log --pretty=format:"%an <%ae>" | sort -u`.
