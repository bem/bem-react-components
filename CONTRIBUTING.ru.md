...
1. [Создать issue](https://github.com/bem/bem-react-components/issues/new) с описанием сути изменений.
...
Список контрибьютеров данного проекта доступен по ссылке https://github.com/bem/bem-react-components/graphs/contributors. Вы так же можете получить его с помощью команды `git log --pretty=format:"%an <%ae>" | sort -u`.
